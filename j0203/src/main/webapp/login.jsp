		...
		<div id="outbox">		
			...
			<div id="contents">
				<div id="member">
					...
					<h3>회원 로그인</h3>
					<div class="informbox">
					<form action="logChk.jsp" method="post" name="logfrm">
						<div class="inform">
							<ul>
							...
							<div class="btn"><button type="submit" class="sbtn">로그인</button></div>
							<div class="chk"><input type="checkbox" name="idsave" id="idsave"/><label for="idsave">아이디 저장</label></div>							
					</form>
